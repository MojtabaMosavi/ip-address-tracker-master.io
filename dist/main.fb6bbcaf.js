  ...
  _createClass(SearchForm, [{
    ...
    value: function _createMap(_ref) {
      var _ref$longitude = _ref.longitude,
          longitude = _ref$longitude === void 0 ? 12 : _ref$longitude,
          _ref$latitude = _ref.latitude,
          latitude = _ref$latitude === void 0 ? 13 : _ref$latitude;
      // map configurations 
      ...
      L.marker([longitude, latitude], {
        icon: location,
        alt: "loaction"
      }).addTo(map).bindPopup("we are here"); // binding a popup to the icon 
      // layer 
...
},{"./utils":"js/utils.js"}],"js/Observer.js":[function(require,module,exports) {
"use strict";
...
var InfoList = /*#__PURE__*/function () {
  ...
  _createClass(InfoList, [{
    ...
    key: "_updateDomNodes",
    value: function _updateDomNodes(_ref) {
      var ip = _ref.ip,
          isp = _ref.isp,
...
var App = function () {
  document.addEventListener("DOMContentLoaded", function () {
    // variables
    var url = "https://geo.ipify.org/api/v1?apiKey=at_ECLl7Ced4VodU7ViC2JH6JFpnaNzx"; // observers 

    var searchForm = new _searchForm.default();
    var infoList = new _Infolist.default(); // subscribing 
...
},{"./searchForm.js":"js/searchForm.js","./Observer.js":"js/Observer.js","./Infolist.js":"js/Infolist.js","./utils.js":"js/utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
